  ...
  return (
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="inline-flex p-4 bg-orange-100 rounded-full mb-8">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 shadow-lg">
          <p className="text-xl text-gray-700 leading-relaxed mb-8">
            ...
            <strong className="text-red-600"> Pilot-Geschäfte in Braunschweig</strong>. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span>Erste Pilot-Partner in Braunschweig gesucht</span>
            </div>
